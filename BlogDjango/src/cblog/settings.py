...
DATABASES = {
    'default': {
        ...
        'HOST': 'database-1.cbm0ea4asfk0.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'awsfinalprojectmustafa' # please enter your s3 bucket name
